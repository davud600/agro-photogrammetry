from index_calculator import Band, EVICalculator, Index, NDVICalculator, SAVICalculator, VARICalculator, RICalculator, BICalculator, IPVICalculator
...
if Index.EVI.value in selected_indices:
    index_calculators.append(EVICalculator(nir_band, red_band, blue_band))
